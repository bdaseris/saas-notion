...
import { File, Folder, Workspace } from "@/providers/supabase/types";
import { usePathname } from "next/navigation";
import { findOneByFileId } from "@/providers/supabase/actions/file/findOne";
...
const AppStateProvider: React.FC<AppStateProviderProps> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    const fetchFiles = async () => {
      const { error: filesError, data } = await findOneByFileId(folderId);
      if (filesError) {
